...
public class ToSmuFromAsanActivity extends Activity {
...
//					int min = o.getInt(TAG_MIN);
				...
				ListAdapter adapter = new SimpleAdapter(ToSmuFromAsanActivity.this,timeBusList,R.layout.list_item,new String[]{TAG_ID, TAG_DEP,TAG_DEST,TAG_HOUR,TAG_MIN},new int[]{R.id.id, R.id.dep,R.id.dest,R.id.hour,R.id.min});
	...
	public class ToSmuFromAsanAsyncTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			System.out.println("아산역에서 학교가는 시간표 어씽크에 들어 왔다.");
			...
			try {
				conn = (HttpURLConnection) new URL(
						params[0] + "/ShuttleServer/main.do?" + "action=searchBusFromAsanToSMUClass").openConnection();
