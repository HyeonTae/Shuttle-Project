...
public class ToSmuFromTerminalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_to_smu_from_asan);
		list = (ListView) findViewById(R.id.listView1);
		timeBusList = new ArrayList<HashMap<String,String>>();
		
		new ToSmuFromTerminalAsyncTask().execute(serverIp);
	}
...
//					int min = o.getInt(TAG_MIN);
				...
				ListAdapter adapter = new SimpleAdapter(ToSmuFromTerminalActivity.this,timeBusList,R.layout.list_item,new String[]{TAG_ID, TAG_DEP,TAG_DEST,TAG_HOUR,TAG_MIN},new int[]{R.id.id, R.id.dep,R.id.dest,R.id.hour,R.id.min});
	...
	public class ToSmuFromTerminalAsyncTask extends AsyncTask<String, Void, String> {

		@Override
		protected String doInBackground(String... params) {
			// TODO Auto-generated method stub
			System.out.println("터미널에서 학교가는 시간표 어씽크에 들어 왔다.");
			...
			try {
				conn = (HttpURLConnection) new URL(
						params[0] + "/ShuttleServer/main.do?" + "action=searchBusFromTerminalToSMUClass").openConnection();
