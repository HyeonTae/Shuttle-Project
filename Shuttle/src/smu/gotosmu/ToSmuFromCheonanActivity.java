...
public class ToSmuFromCheonanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new ToSmuFromCheonanAsyncTask().execute(serverIp);
	}
...
//					int min = o.getInt(TAG_MIN);
				...
				ListAdapter adapter = new SimpleAdapter(ToSmuFromCheonanActivity.this,timeBusList,R.layout.list_item,new String[]{TAG_ID, TAG_DEP,TAG_DEST,TAG_HOUR,TAG_MIN},new int[]{R.id.id, R.id.dep,R.id.dest,R.id.hour,R.id.min});
	...
	public class ToSmuFromCheonanAsyncTask extends AsyncTask<String, Void, String> {

		@Override
		protected String doInBackground(String... params) {
			// TODO Auto-generated method stub
			System.out.println("천안역에서 학교가는 시간표 어씽크에 들어 왔다.");
			...
			try {
				conn = (HttpURLConnection) new URL(
						params[0] + "/ShuttleServer/main.do?" + "action=searchBusFromCheonAnToSMUClass").openConnection();
