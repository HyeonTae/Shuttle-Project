...
<body>
	...
	<div class="container">
		<ul>
			...
			<li class='sub-menu'><a href="#">셔틀관리<i
				...
				<ul>
					...
					<li><a href="main.do?action=searchBusFromAsanToSMU">셔틀버스시간표
							조회 (아산역 -> 학교)</a></li>
					<li><a href="main.do?action=searchBusFromCheonAnToSMU">셔틀버스시간표
							조회 (천안역 -> 학교)</a></li>
					<li><a href="main.do?action=searchBusFromTerminalToSMU">셔틀버스시간표
							조회 (터미널 -> 학교)</a></li>
					<li><a href="main.do?action=searchBusForAsan">셔틀버스시간표 조회
							(학교 -> 아산역)</a></li>
					<li><a href="main.do?action=searchBusForCheonAn">셔틀버스시간표
							조회 (학교 -> 천안역)</a></li>
					<li><a href="main.do?action=searchBusForTerminal">셔틀버스시간표
							조회 (학교 -> 터미널)</a></li>
				</ul></li>
		</ul>
	</div>
